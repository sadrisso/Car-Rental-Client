        ...
        <div className="md:pt-28">
          <div className="overflow-x-auto">
            <div className="flex flex-col md:flex-row gap-4 justify-between md:w-2/3 items-center mx-auto">
              <h1 className="text-center font-bold text-3xl mb-5 text-amber-500">
                My Cars
              </h1>
                ...
                {myCar.map((car, i) => (
                  <tr key={i}>
                    ...
                    <td>
                      <img
                        src={car?.photo}
                        className="w-[70px] h-[50px] mx-auto"
                        alt=""
                      />
                    </td>
                    <td>{car.carModel}</td>
        ...
        <div className="modal-box w-11/12 max-w-5xl">
          ...
          <div className="modal-action justify-center">
            <form method="dialog">
              ...
              <button className="mt-2 text-red-900" onClick={closeModal}>
                <i class="fa-regular fa-circle-xmark text-2xl text-red-500 hover:text-red-300"></i>
              </button>
            </form>
          </div>
        </div>
